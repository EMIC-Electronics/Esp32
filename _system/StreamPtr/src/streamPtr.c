...
void streamPushCtr(streamPtr_t* stream,void* dato)
{
...
void streamPush(streamPtr_t* stream,void* dato)
{
...
void* streamPop(streamPtr_t* stream)
{
   void* dato;
...
void streamOpenWriteFrame(streamPtr_t* stream)
{
...
void* streamOpenReadFrame(streamPtr_t* stream)
{
...
void* streamReOpenReadFrame(streamPtr_t* stream)
{
...
void* streamCloseReadFrame(streamPtr_t* stream)
{
